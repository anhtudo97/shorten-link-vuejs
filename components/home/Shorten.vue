...
<transition-group name="fade" mode="out-in">
    <v-row key="1" class="shortened justify-space-between align-center mx-0 mb-3">
        ...
        <v-col cols="12" md="4" lg="4" class="shortened__shortened-service text-center">
            <button class="shortened-button" @click="doCopy">
                <div class="shortened-text">Copy</div>
            </button>
        </v-col>
    </v-row>
    <v-snackbar key="2" v-model="showAlert" centered color="success" timeout="2000">
        Link copied
