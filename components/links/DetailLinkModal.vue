        ...
        <div v-if="!loading">
            ...
            <v-row class="mx-0">
                <v-col cols="12" class="px-3 px-sm-5">
                    <div class="d-flex justify-space-between modal-detail-link__dialog-main align-center mb-10 flex-wrap">
                        <div class="d-flex align-center">
                            <img loading="lazy" class="img-favicon mr-3" :src="
                    `https://www.google.com/s2/favicons?domain=${destination}`
                  " alt="favicon" />
                            <a :href="`https://${shorten}`" target="_blank" class="main-title text-overflow-hidden pb-3 pb-sm-0">{{ shorten }}</a>
                        </div>
                        <div class="d-flex dialog-link-service align-center">
                            <div @click="doCopy" class="dialog-button-copy mr-3">
                                Copy
                            </div>
                            <button class="dialog-button button-normal" aria-label="Edit" @click.stop="modalEditLink = true">
                                Edit
                            </button>
                        </div>
                    </div>
                    <div class="modal-detail-link__dialog-sub">
                        ...
                        <v-row class="information d-flex align-center">
                            ...
                            <v-col cols="12" md="9">
                                <button class="remove-button button-warning" aria-label="Remove this link" @click.stop="isRemoveModal = true">
                                    Remove this link
                                </button>
                            </v-col>
                        </v-row>
...
export default {
    ...
    methods: {
        doCopy() {
            const link = `http://${this.shorten}`;
            this.$copyText(link).then((this.showAlertCopy = true));
        },
        closeRemoveModal() {
